# 接受数组的 c 程序&使用指针交换 lemon

> 原文:[https://learnet utortials . com/c-programming/programs/swap-array-elements](https://learnetutorials.com/c-programming/programs/swap-array-elements)
