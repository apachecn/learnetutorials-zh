...
> 原文:[https://learnet utortials . com/python/programs/check-Armstrong-number](https://learnetutorials.com/python/programs/check-armstrong-number)

在这个简单的 python 程序中，我们需要检查一个阿姆斯特朗编号。这是一个初级 python 程序。
