...
> 原文:[https://learnetutorials.com/python/python-sets](https://learnetutorials.com/python/python-sets)
...
![Python Sets](../Images/211a5171a70ffbb0304a3bf7cbc49577.png)

A 和 B 的并集将是一个包含 A 和 B 中所有唯一元素的新集合。重复的元素将从集合中排除。下图显示了 A|B 的维恩图

![Python Sets](../Images/7ba35f514ba6352818bf80882f66085d.png)
...
![Python Intersection Sets](../Images/8135ed34561825846f681b128b7c679d.png)

`A`和`B`的交集返回 A 和 b 中有公共元素的新集，换句话说，我们可以说重复的值作为公共元素。下图为`A&B`的文氏图。

![Python Sets](../Images/797596e082cb447452df566a0bf93f35.png)
...
![Python Sets](../Images/16d186b1386a3878328bcbe4dd7bfdb2.png)

下图是表示集合差异的维恩图。

![Python Sets](../Images/84dd58aac0d3a3c13e4ba746239a8572.png)

### 设定差异:A-B

![Python Sets](../Images/096ded7db23e0524e9be74ae1678638a.png)
...
![Python Tuple Indexing](../Images/236a2b36f710d0107514c527412d9b76.png)

使用文氏图可以最好地说明对称差异

![Python Tuple Indexing](../Images/d09b01ca02e10331aeba0d20185bfeba.png)
