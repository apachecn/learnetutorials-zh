...
> 原文:[https://learnet utortials . com/python/python-函数-教程](https://learnetutorials.com/python/python-functions-tutorials)
...
![Python Function working](../Images/b881c7ef2072aa48f55e469ff9b1b5ea.png)
...
1.  ### 必需的参数
    ...
    **输出:**
    ...
    ![Python Function - Required Arguments](../Images/58296e943bff339cc429f3d11bcacbfb.png)
...
4.  ### 任意参数/可变长度参数
    ...
    *   ### 非关键字任意参数
        ...
        ![Python Non keyword arbitrary arguments](../Images/c48c77457764eadde24a629ba77becf5.png)
