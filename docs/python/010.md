...
> 原文:[https://learnetutorials.com/python/python-lists](https://learnetutorials.com/python/python-lists)
...
索引是为列表中的项目分配一个编号以便于访问的过程。索引总是从零开始，并且必须是整数。
python 列表中的两种索引类型是:
...
![Python Indexing](../Images/c0c952fc8119d99fb63bd66911a0cc81.png)
...
![Python Indexing](../Images/9d8f21c371cdb09e4f1bc68e48e7ad7f.png)
...
![Nested List in Python](../Images/f20bbf68a5cae9974b826289f4145eb1.png)

为了更好地理解，嵌套列表可以用如下分层结构表示。

![Nested List Structure in Python](../Images/1c7dfd4f52daa83ce02b09fc463da294.png)
...
![Nested List Structure in Python](../Images/8b54ac0bcff6f03f79062bf2bbe233f0.png)
