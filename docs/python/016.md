...
> 原文:[https://learnetutorials.com/python/python-loop-tutorials](https://learnetutorials.com/python/python-loop-tutorials)

在本教程中，您将通过示例掌握 python 中所有关于循环的知识；比如 for 循环和 while 循环，它们的语法和流程图，以及如何嵌套循环。此外，我们还将通过示例学习如何使用中断、继续和传递等关键词来控制循环流，以及如何在“for loop”中使用 range 函数。
...
![Python For Flowchart](../Images/3344bb1cc6c73e8fe29593631182a384.png)
...
![Python While Flowchart](../Images/a15c60f07cc22e52223a6c9d4474dbb4.png)
...
![Python Break Flowchart](../Images/afb00292015d426df97b481c79113770.png)
...
![Python Continue in Loop](../Images/34e53e2323e0ae653e80be86de74d2b3.png)
