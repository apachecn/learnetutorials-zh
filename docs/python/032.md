...
> 原文:[https://learnetutorials.com/python/property](https://learnetutorials.com/python/property)

在本教程中，您将借助简单易举的例子，了解@property decorator，何时以及如何在 python 中使用@property decorator。
...
**属性装饰器@property decorator 基本上是一个内置的装饰器，它的主要目的之一是使用类方法作为属性，尽管它是一个带有括号()**的方法。
