...
> 原文:[https://learnetutorials.com/python/regular-expressions](https://learnetutorials.com/python/regular-expressions)
...
![Metacharacters](../Images/0fe4d42b851459f28fb97f8b276569f5.png)
...
1.  ### [] -方括号
    ...
    ![Example of Square brackets](../Images/37ef855921520097d53514a6b849c1fc.png)

    ### 方括号示例

    为了更好地理解，正则表达式可以可视化为

    ![regular expression can be visualised](../Images/97d377fe9e9eec4f651f534d85c8ff3f.png)
    1.  **Square brackets for Character set range:**

        使用方括号[]我们还可以表示一系列字符。**“-”(连字符)**用于表示一系列字符。例如，

        ![Example of Square brackets](../Images/1d112626da9415c3d19c0df8161798f1.png)
...
2.  ### 。-句号
    ...
    ![Example of Period symbol](../Images/8f2a7781c0e58365797d38e21c0b47b7.png)
...
3.  ### ^ -脱字符
    ...
    ![Example of ^(caret symbol)](../Images/783760f689148d2992ec5de76bbd31f0.png)
...
4.  ### 美元
    ...
    ![Hierarchical structure of the package](../Images/c9bfd63e345afcf3cd948f6998cb5687.png)
...
1.  ### * -星号:
    ...
    ![Example of Asterisk](../Images/9d306d5b0533c2790616ac0a500fb440.png)
...
2.  ### + - Plus
    ...
    **![(+)/](../Images/052a8dfebec645a54a58b3e591bc0f32.png)
...
***   ### ？-问号
    ...
    ![Example of question mark(?)](../Images/f38f72d416bb77083dfebb64e6214494.png)
    ...
    *   ### {} -大括号
    ...
    ![Example of Curly braces](../Images/314b1bcdff9ffc64f1c1cea7fc824279.png)
...
1.  ### | -交替
    ...
    ![Hierarchical structure of the package](../Images/f0ca796e5c917a463613d7dff3654f8c.png)
...
1.  ### 括号()
    ...
    ![Example of parenthesis (](../Images/a6481698edb35e7baa4b9388bc56eeb4.png)
...
![Special sequences](../Images/8c1fbfbb107881e3384b05b56c487f95.png)
