...
> 原文:[https://learnetutorials.com/python/interview-questions](https://learnetutorials.com/python/interview-questions)
 ...
 *文档字符串或文档字符串用于在代码中关联文档。文档字符串使用三倍单引号或三倍双引号。Python 中的注释以#开头。*  *## [*20 解释关键词论据？*](#qus_collapse19)*T7】*
...
所有这些对象都有一个`iter()`方法，用于使用`iter()`方法获取迭代器。*  *## [*65 你对 python 中的 __iter()__ 和 __next()__ 了解多少？*](#qus_collapse64)*T7】*
 ...
 *标识符可以由字母、数字和下划线组成。保留的关键字不能用作标识符。标识符不能以数字开头。标识符可以是任何长度。*  *## [*75 关键词在 python 中断言的目的是什么？*](#qus_collapse74)*T7】*
...
*   %x/%X -十六进制表示的整数(小写/大写)*  *## [*79 解释破并续关键词的用法？*](#qus_collapse78)*T7】*
 ...
 *“是”和“不是”是 python 中的标识运算符。如果两个操作数指向同一个对象，则“是”返回“真”，否则返回“假”。如果两个操作数都指向同一个对象，则“不是”返回假，否则返回假。*  *## [*100python 中 globals()和 locals()返回哪个数据结构？这些功能的目的是什么？*](#qus_collapse99)*T7】*
