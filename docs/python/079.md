# Python 程序打印数组奇数位置的元素

> 原文:[https://learnet utortials . com/python/programs/print-odd position-array-elements](https://learnetutorials.com/python/programs/print-oddposition-array-elements)
